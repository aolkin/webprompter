# Django settings for webprompter project.
...
ADMINS = (
    ("Aaron Olkin", "aaronolkin@gmail.com"),
)
...
SECRET_KEY = 'u*aq=s$*gb69=5e57&8s0m*1y0y%%39!##25oc$v^(4vl5_1rf'
...
WSGI_APPLICATION = 'webprompter.wsgi.application'
